...
(
    ...
    FOREIGN KEY (major_id) REFERENCES major_table (major_id),
    minor_id             TINYINT UNSIGNED,
    FOREIGN KEY (minor_id) REFERENCES major_table (major_id),
    major2_id            TINYINT UNSIGNED,
    FOREIGN KEY (major2_id) REFERENCES major_table (major_id),
    major3_id            TINYINT UNSIGNED,
    FOREIGN KEY (major3_id) REFERENCES major_table (major_id),
    ...
    user_attendance      TINYINT UNSIGNED DEFAULT '100' NOT NULL
);
